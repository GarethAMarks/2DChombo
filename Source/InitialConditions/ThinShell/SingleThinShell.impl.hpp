...
#if !defined(SINGLETHINSHELL_HPP_)
#error "This file should only be included through BosonStar.hpp"
#endif

#ifndef SINGLETHINSHELL_IMPL_HPP_
#define SINGLETHINSHELL_IMPL_HPP_

#include "ThinShellSolution.hpp" //for BosonStarSolution class

inline SingleThinShell::SingleThinShell(BosonStar_params_t a_params_BosonStar,
...
void SingleThinShell::read_1d_solution(const double max_r)
{
    try
    {
...
void SingleThinShell::compute(Cell<data_t> current_cell) const
{
